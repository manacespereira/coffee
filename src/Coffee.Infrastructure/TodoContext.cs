...
public class TodoDbContextDesignFactory : IDesignTimeDbContextFactory<TodoContext>
{
    public TodoContext CreateDbContext(string[] args)
    {
        var optionsBuilder = new DbContextOptionsBuilder<TodoContext>()
            .UseNpgsql(
                "Host=localhost;Port=5432;Database=TODO_MANAGER;Username=postgres;Password=123123");
